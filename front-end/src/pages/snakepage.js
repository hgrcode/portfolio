...
const Snake = () => {
        ...
        const canvasObj = snakeboard.current;
        const snakeboard_ctx = snakeboard.useEffect("2d");
        ...
        function drawCanvas(snakeboard_ctx, location) {
    ...
    return (
        <Container>
            ...
            <div class = 'container' > 
                ...
                <div id="reset"></div>
                <canvas id="snakeboard" width="359" height="350"></canvas>
            </div>  
